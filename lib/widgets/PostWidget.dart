...
import 'package:Pilgrimage/pages/CommentsPage.dart';
import 'package:Pilgrimage/pages/HomePage.dart';
import 'package:Pilgrimage/pages/ProfilePage.dart';
import 'package:Pilgrimage/widgets/CImageWidget.dart';
...
class _PostState extends State<Post> {
  ...
  removeUserPost() async {
    ...
    QuerySnapshot commentsQuerySnapshot = await commentsRefrence
        .document(postId)
        .collection("comments")
        .getDocuments();
